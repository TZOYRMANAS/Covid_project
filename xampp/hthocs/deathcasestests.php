<h3 >a. Εμφάνιση συνολικού αριθμού κρουσμάτων, θανάτων και τεστ ανά χώρα της ΕΕ (επιλογή χώρας από drop-down list)</h3>
<form method="post">
...
$sql="SELECT 
	...
	$result = $db->mysqli_($sql);
	//echo $sql;
	$totaltests=mysqli_fetch_array($result);
